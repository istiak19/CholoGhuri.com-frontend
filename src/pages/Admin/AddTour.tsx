...
import type { IDivision, IErrorResponse } from "@/types";
            ...
            <Card>
                <CardHeader className="p-3 border-b text-center">
                    ...
                    <CardDescription className="text-muted-foreground mt-1">
                        Fill in the details below to create a new tour and make it available for booking.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex-1 ">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    {
                                                        divisionData?.map((data: IDivision) => <SelectItem key={data._id} value={data._id}>{data.name}</SelectItem>)
                                                    }
                                                </SelectContent>
                                            </Select>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex-1">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    {
                                                        tourTypeData?.map((type: { _id: string, name: string }) => <SelectItem key={type._id} value={type._id}>{type.name}</SelectItem>)
                                                    }
                                                </SelectContent>
                                            </Select>
                                            <FormMessage />
                ...
                <CardFooter className="flex justify-end">
                    <Button type="submit" className="cursor-pointer" form="add-tour-form">
                        Create Tour
                    </Button>
                </CardFooter>
            </Card>
